...
log_path = "logs/bovtrans_seq2seq/Down_HA_of20_Hidden200_Pre30Ep_C"+str(cluster_size)
model_path = "logs/bovtrans_seq2seq/HA_of20_Hidden200_C"+str(cluster_size)+"_SSFuturePred_30Ep/"#transformer_ep30_S30C300_SGD.pt"
...
#    ANNOTATION_FILE = "/home/arpan/VisionWorkspace/Cricket/stroke_recognition/config/stroke_types_classes.txt"
    ...
    print("OF20 BOV Transformer HA with Embedding (Downstream Finetuning of Seq2Seq Model...")
