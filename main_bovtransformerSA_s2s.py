...
log_path = "logs/bovtrans_seq2seq/SA_of20_Hidden200_C300_SSFuturePred" #_C1000_pretrained"
...
#                inputs = inputs.t().contiguous().to(device)       # Convert to (SEQ, BATCH)
...
#                              sampler=sampler, worker_init_fn=np.random.seed(12))
    ...
    model = tt.TransformerModelSA(ntokens, emsize, nhead, nhid, nlayers, dropout)
...
if __name__ == '__main__':
    ...
    print("OF20 BOV Transformer SA without Embedding (Predict Word Sequences) ...")
